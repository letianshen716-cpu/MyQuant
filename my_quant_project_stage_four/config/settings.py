...
# ================= 0. 全局 SSL 证书补丁 (规避 Windows 证书解析异常) =================
...
BACKTEST_CONFIG = {
    ...
    "end_date": "2026-12-31",
    "friction_cost": 0.003,         # 单边调仓摩擦成本 (0.3%)
    "min_stocks_per_cross": 30,     # 单一截面有效股票最低门槛
    "quantiles": 5,                 # 分层回测分组数
    "hold_top_n": 50,               # 默认组合持仓标的数量
    "batch_size": 300,              # 数据库分批读取批次大小
...
# ================= 4. 因子计算超参数 =================
FACTOR_CONFIG = {
    "momentum_short_window": 10,    # 短期反转周期
